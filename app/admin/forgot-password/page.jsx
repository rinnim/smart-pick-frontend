...
const AdminForgottenPasswordPage = () => {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      await toast.promise(
        axios.post(
          `${process.env.NEXT_PUBLIC_API_URL}/auth/admin/forgot-password/send-otp`,
          {
  ...
  return (
    <div>
      <p>Admin Forgotten Password Page</p>
    </div>
  );
};

export default AdminForgottenPasswordPage;
